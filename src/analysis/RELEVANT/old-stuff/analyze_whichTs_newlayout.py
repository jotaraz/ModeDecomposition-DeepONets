...
def plot_multLLW(showlast=True):
    ...
    for whT in all_whTs:
        ...
        axs[plotinfo[whT]["ax"]].plot(xax, etr, '--', color=plotinfo[whT]["color"], linewidth=3)
        axs[plotinfo[whT]["ax"]].plot(xax, ete, 'o-', color=plotinfo[whT]["color"], label=don_code.trunk_names[whT], linewidth=3)
...
fig.subplots_adjust(wspace=0.0, hspace=0.0, right=0.95, left=0.15, top=0.95, bottom=0.13)
