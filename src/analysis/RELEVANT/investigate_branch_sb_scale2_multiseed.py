...
## ---------------------------------------------------------------------------
## MULTISEED VARIANT of investigate_branch_sb_scale2.py
## The plotted mode losses are the ARITHMETIC MEAN over seeds v0..v9.  They are
## stored raw in log_modes.txt (not log10), so averaging the file directly gives
## the arithmetic mean of the plotted quantity.  The frequencies and singular
## values overlaid on these panels are data-derived and identical across seeds.
