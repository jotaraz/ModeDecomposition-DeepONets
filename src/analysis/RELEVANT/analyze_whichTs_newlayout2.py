...
def plot_multLLW(showlast=True):
    ...
    for i in nets.keys():
        ...
        if ret is None:
            continue 
        if showlast:
            grand_dict[whT][llw] =  (ret["save"]["last_values"][0], ret["save"]["last_values"][1], ret["proj_error_tr"], ret["proj_error_te"])
        else:
            grand_dict[whT][llw] =  (ret["save"]["atbesttr_values"][0], ret["save"]["atbesttr_values"][1], ret["proj_error_tr"], ret["proj_error_te"])
