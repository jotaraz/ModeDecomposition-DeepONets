#!/bin/bash
# Wrapper executed by HTCondor on the compute node for run_normal_sgd.py.
#
# run_normal_sgd.py does `os.system("python execute_don.py ...")`, so we must:
